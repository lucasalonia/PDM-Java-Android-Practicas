...
*   **Arquitectura:** Implementación de **View Binding** para la vinculación de vistas.
...
| **Clase12MenuNavegable** | Implementación de menús de navegación y DrawerLayout. |
| **Clase15Geolocalizacion** | Uso de servicios de ubicación y permisos de GPS. |
| **Clase16GoogleMaps** | Integración y visualización de mapas de Google. |
| **Clase17Sensores** | Captura de datos de hardware (Acelerómetro, Giroscopio, etc.). |
| **ClaseBroadcastUSB / USB19** | Manejo de eventos de conexión y estado del puerto USB. |
